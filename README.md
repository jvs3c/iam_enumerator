This script detects potential privilege escalation vulnerabilities in AWS IAM policies. Enumerates users & checks both attached managed  and inline policies.
